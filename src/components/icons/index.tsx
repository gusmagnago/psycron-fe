...
import { Archive as IconArchive } from './Archive';
import { Available as IconAvailable } from './Available';
import { Ban as IconBan } from './Ban';
import { Bell as IconBell } from './Bell';
...
import { Maximize as IconMaximize } from './Maximize';
import { Minus as IconMinus } from './Minus';
import { Month as IconMonth } from './Month';
import { Plus as IconPlus } from './Plus';
...
import { Patients as IconPatients } from './user/patient/Patients';
import { RemovePatient as IconRemovePatient } from './user/patient/RemovePatient';
import { ArrowUpDown as IconArrowUpDown } from './ArrowUpDown';
import { BookUser as IconBookUser } from './BookUser';
import { ClockIn as IconClockIn } from './ClockIn';
import { Columns3Cog as IconColumns3Cog } from './Columns3Cog';
import { Copy as IconCopy } from './Copy';
import { Edit as IconEdit } from './Edit';
import { FileExclamationPoint as IconFileExclamationPoint } from './FileExclamationPoint';
import { FilterIcon as IconFilter } from './Filter';
import { FilterCloseIcon as IconFilterClose } from './FilterClose';
import { FilterFullIcon as IconFilterFull } from './FilterFull';
import { Funnel as IconFunnel } from './Funnel';
...
import { ReceiptText as IconReceiptText } from './ReceiptText';
import { Refresh as IconRefresh } from './Refresh';
import { ScanEye as IconScanEye } from './ScanEye';
import { Search as IconSearch } from './Search';
import { Security as IconSecurity } from './Security';
...
export const Refresh = withIconColor(IconRefresh);
export const Search = withIconColor(IconSearch);
export const Subscription = withIconColor(IconSubscription);
export const Security = withIconColor(IconSecurity);
export const Account = withIconColor(IconAccount);
...
export const Archive = withIconColor(IconArchive);
export const Ban = withIconColor(IconBan);
export const Bell = withIconColor(IconBell);
...
export const FilterFull = withIconColor(IconFilterFull);
...
export const Maximize = withIconColor(IconMaximize);
export const Messenger = withIconColor(IconMessenger);
export const Minus = withIconColor(IconMinus);
...
export const ArrowUpDown = withIconColor(IconArrowUpDown);
export const BookUser = withIconColor(IconBookUser);
export const Columns3Cog = withIconColor(IconColumns3Cog);
export const FileExclamationPoint = withIconColor(IconFileExclamationPoint);
export const Funnel = withIconColor(IconFunnel);
export const ReceiptText = withIconColor(IconReceiptText);
export const ScanEye = withIconColor(IconScanEye);
