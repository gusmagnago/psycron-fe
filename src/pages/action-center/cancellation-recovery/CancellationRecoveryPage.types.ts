...
export type CancellationRecoveryStatusFilter =
	| 'needs_action'
	| 'resolved'
	| 'all';
...
export interface CancellationRecoveryFilters {
	...
	reasonCode: string;
	status: CancellationRecoveryStatusFilter;
}
...
export interface CancellationRecoveryFilterControls {
	...
	setStatus: (status: CancellationRecoveryStatusFilter) => void;
}
...
export interface CancellationRecoveryDetailPanelProps {
	isArchiving: boolean;
	isReopening: boolean;
	onArchive: (row: CancellationRecoveryRow) => void;
	onOpenPatient: (patientId: string) => void;
	onRebook: (row: CancellationRecoveryRow) => void;
