...
// Rows 5-6: this-week(5) + weekly-chart(7) = 12
...
export const TILE_DESKTOP: Record<DashboardTileId, { col: number; row: number }> = {
	...
	'this-week': { col: 5, row: 2 },
	'weekly-chart': { col: 7, row: 2 },
};
...
// Row 4: this-week(2) + weekly-chart(4) = 6
...
export const TILE_TABLET: Record<DashboardTileId, { col: number; row: number }> = {
	...
	'this-week': { col: 2, row: 2 },
	'weekly-chart': { col: 4, row: 2 },
};
